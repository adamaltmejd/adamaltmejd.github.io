...
authors:
  ...
  - name: "Evelina Björkegren"
    site: "https://sites.google.com/view/evelinabjorkegren"
  - name: "Torsten Persson"
    site: "http://perseus.iies.su.se/~tpers/"
figure_caption: "Multidimensional inequality in 2020. Radar plots show relative risks for nine negative life events across four social gradients: gender (A), region of birth (B), education (C), and income (D). Each colored curve represents a social group. Values are estimated as predictive margins relative to the population average, controlling for age and region. A value of 1.5 means the group is 50% more likely to experience the event."
abstract: >
